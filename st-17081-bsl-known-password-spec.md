...
- **17085:** BKP5R layout = [9:0] ver, [13:10] attempts, bit 14 WRITTEN, bit 15 VALID, [31:16] heal hour. Inherited garbage in the register (it was "unused" for years) parked healthy TIs at their first 17084 boot on 2 of 6 bench units; a word without VALID is normalised to 0x8000 at boot. Seed = VALID+WRITTEN word, used only when the TI has not been heard this uptime.
